...
- ✅ `scaffold/scaffold.sh` — fresh scaffold + `--sync`, tested end-to-end against a real target: clone, copy, render, `<<FILL:...>>` validation gate, idempotency refusal, sync diff-preview, drifted-file overwrite with constitution-value preservation
