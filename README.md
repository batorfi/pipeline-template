...
(Or, from an existing local clone: `scaffold/scaffold.sh --template-version v0.1.4 --target ./my-project`.)

**2. Follow the printed checklist** — fill in `constitution.md`'s `<<FILL:...>>` markers, stand up the 3 cmux workspaces, start the dashboard, and run one deliberately trivial synthetic feature through all 9 gates by hand before trusting it with anything real. Full walkthrough: `docs/scaffolding-guide.md`.
...
| Get the dashboard running and troubleshoot it | `docs/running-the-dashboard.md` |
